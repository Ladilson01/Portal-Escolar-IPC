const teachers = [
    ...
    { name: 'Alexandre Poba', img: 'Images/Professores/Alexandre Poba.webp', curso: 'Matemática',link:'alexandre_poba.html', discipline: 'Matemática', classes: ['Décima Primeira', 'Décima Segunda'] },
    ...
    { name: 'Celso Vasconcelos', img: 'Images/Professores/Celso Vasconselos.webp',link:'celso_vasconcelos.html', curso: 'Inglês', discipline: 'Inglês', classes: ['Décima'] },
    { name: 'Cláudia Abrãao', img: 'Images/Professores/Cláudia Abrãao.webp', curso: 'FAI' ,link:'claudia_abraao.html',discipline: 'FAI', classes: ['Décima', 'Décima Terceira'] },
    ...
    { name: 'Filemon Muanda', img: 'Images/Professores/Filemon Muanda.webp', curso: 'Electrotecnia',link:'filemon_muanda.html', discipline: 'Electrotecnia', classes: ['Décima Primeira'] },
    { name: 'Hilário Luemba', img: 'Images/Professores/Hilário Luemba.webp', curso: 'TREI',link:'hilario_luemba.html', discipline: 'TREI', classes: ['Décima Segunda'] },
    { name: 'Inês Filipe', img: 'Images/Professores/Inês Filipe.webp', curso: 'Química',link:'ines_filipe.html', discipline: 'Química', classes: ['Décima Primeira'] },
    ...
    { name: 'Joel Simples', img: 'Images/Professores/Joel Simples.webp', curso: 'Inglês',link:'joel_simples.html', discipline: 'Inglês', classes: ['Décima Primeira'] },
    {name: 'José Mampumpo', img: 'Images/Professores/José Mampumbo.webp', curso: 'Matemática',link:'jose_mampumbo.html', discipline: 'Matemática', classes: ['Décima Segunda'] },
    ...
    { name: 'Mateus Kanga', img: 'Images/Professores/Mateus Kanga.webp', curso: 'DP',link:'mateus_kanga.html', discipline: 'DP', classes: ['Décima Primeira, Décima Segunda'] },
    ...
    { name: 'Natividade Gouveia', img: 'Images/Professores/Natividade Gouveia.webp', curso: 'FAI',link:'natividade_gouveia.html', discipline: 'FAI', classes: ['Décima'] },
    { name: 'Silvana Capita', img: 'Images/Professores/Silvana Capita.webp', curso: 'TIC',link:'silvana_capita.html', discipline: 'TIC', classes: ['Décima'] },
    { name: 'Wagnel Sambo', img: 'Images/Professores/Wagnel Sambo.webp', curso: 'TLP', link:'wagnel_sambo.html',discipline: 'TLP', classes: ['Décima', 'Décima Primeira'] },/*
    ...
    */{ name: 'Alexandre Vela', img: 'Images/Professores/Alexandre Vela .webp',curso: 'Matemática',link:'alexandre_vela.html', discipline: 'Matemática',classes: ['Décima segunda'] },
