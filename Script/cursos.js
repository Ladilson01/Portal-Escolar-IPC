...
const cursos = [
    ...
    },
    {
        ...
        imagem: "Images/Desenhador Projectista/Desenhador Projectista.webp",
    ...
    },
    {
        ...
        imagem:"Images/Electricidade/Electricidade.webp",
    ...
    },
    {
        ...
        imagem: "Images/Electrónica/Electrónica.webp",
    ...
    },
    {
        ...
        imagem: "Images/E.Renovável/Energia Renovável.webp",
    ...
    },
    {
        ...
        imagem: "Images/Informática/Informática.webp",
    ...
    },
    {
        ...
        imagem:"Images/M.Industrial/Manunteção Industrial.webp",
        link:"manutencao_industrial.html",
    },
    {
        ...
        imagem: "Images/M.M/Máquinas e Motores.webp",
    ...
    },
    {
        ...
        imagem: "Images/Metalomecânica/Metalomecânica.webp",
...
function gerarCursos() {
    ...
    cursos.forEach(curso => {
        ...
        cursoDiv.innerHTML = `
    <a href="${curso.link}">
        <img class="imgcurso" src="${curso.imagem}" alt="${curso.nome}" loading="lazy">
    </a>
    <h2>${curso.nome}</h2>
    <p>${curso.descricao}</p>
`;
